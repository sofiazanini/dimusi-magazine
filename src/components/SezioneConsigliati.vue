    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5 w-full">
      ...
      >
        ...
        <div class="relative w-full aspect-square bg-zinc-950 overflow-hidden">
          <img :src="c.cover" :alt="c.titolo" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out" />
        ...
        <!-- Testo del consiglio e link Spotify -->
