<template>
    <div class="relative w-full">
        <section ref="sectionRef" class="relative w-full min-h-screen bg-transparent flex flex-col justify-between p-6 md:p-12 lg:p-16 z-20 overflow-hidden">
            <!-- angoli sopra -->
            ...
            <div class="relative w-full my-auto min-h-125 flex items-center justify-center perspective-[1000px]">
                ...
                <!-- 02 domande -->
                <div ref="stepQ1Ref" class="w-full max-w-6xl absolute inset-0 flex flex-col justify-center opacity-0">
                    <span class="q1-bg-num absolute top-2 md:top-4 left-0 font-pixel text-9xl sm:text-8xl md:text-9xl lg:text-[180px] text-black/6 leading-none -z-10 translate-y-8">01</span>
                    <div class="space-y-2 md:space-y-4 relative z-10">
                        <div class="overflow-hidden">
                            <p class="q1-tag font-mono text-xs sm:text-sm text-red-600 uppercase tracking-widest block translate-y-full">[ Q.01 — IL RUOLO DELL'ANIMA ]</p>
                        </div>
                        <div class="overflow-hidden">
                ...
                <div ref="stepQ2Ref" class="w-full max-w-6xl absolute inset-0 flex flex-col justify-center items-end text-right opacity-0">
                    <span class="q2-bg-num absolute top-2 md:top-4 right-0 font-pixel text-9xl sm:text-8xl md:text-9xl lg:text-[180px] text-black/6 leading-none -z-10 translate-y-8">02</span>
                    <div class="space-y-2 md:space-y-4 max-w-4xl relative z-10">
                        <div class="overflow-hidden">
                            <p class="q2-tag font-mono text-xs sm:text-sm text-red-600 uppercase tracking-widest block translate-y-full">[ Q.02 — IL RUOLO DELL'ANIMA ]</p>
                        </div>
                        <div class="overflow-hidden">
